...
| Workstream | 기준 | 현재 달성 |
|-----------|------|:--------:|
| WS3-1 | 유효 세션 300+ | ⚠️ 97/300 (2026-03-05 스냅샷 기준) |
| WS3-2 | session_id 누락률 1% 미만 | ✅ 0.0000% (최근 7일) |
| WS3-3 | 28일 중 27일 스냅샷 | ⚠️ 9/28 (동적 임계값 8/28은 충족) |
| WS4-1 | verify:premerge 3회 Green | ✅ 달성 (테스트 106/106 통과) |
| WS4-2 | verify:release 1회 Green | ✅ 달성 |
| WS4-3 | 트라이얼 정책 단일화 | ✅ |
| WS5-1 | 상업 증빙 100% 추적 | ⚠️ 구조 완료 / 실거래 전환 전(유료 0건) |
| WS5-2 | 법무 증빙 패키지화 | ✅ 완료 |
| WS5-3 | 보안 증빙 패키지화 | ✅ 완료 |

> 남은 블로커: 실결제 전환 전 `MRR 계산식 ↔ raw 원장` 일치 검증 불가
