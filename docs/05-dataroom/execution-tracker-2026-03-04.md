...
| WS4-08 | Release | WB-02/03/04 처리 (chunk/import 경고 복구) | 맹준호 | denjoy | 2026-03-08 | DONE | `docs/04-report/release-warning-remediation-2026-03-05.md`, `vite.config.ts`, `services/cryptoUtils.ts` |
| WS3-01 | Funnel | 이벤트 스키마 동결 | denjoy | 맹준호 | 2026-03-05 | DONE | `docs/03-design/event-schema-freeze-2026-03-04.md` (v1.1, 2026-03-05), `docs/03-design/event-schema-freeze-validation-2026-03-05.md` |
| WS3-02 | Funnel | 일별 스냅샷 자동화 구축 | 맹준호 | denjoy | 2026-03-11 | DONE | `scripts/admin-traffic-snapshot.mjs`, `scripts/traffic-snapshot-coverage.mjs`, `.github/workflows/daily-snapshot.yml`, `docs/04-report/traffic-kpi-coverage.md` |
| WS3-03 | Funnel | session_id 누락률 주간 점검 | denjoy | 맹준호 | Weekly | DONE (2026-03-05) | `docs/04-report/traffic-kpi-daily/session-quality-check-2026-03-05.md` |
...
| WS5-05 | Data Room | 보안 운영 증빙 첨부 | 맹준호 | denjoy | 2026-03-16 | DONE | `04-security-operations/2026-03-05_security-operations-weekly-update_v1.md`, `04-security-operations/2026-03-05_security-operations-evidence-refresh_v1.md`, `04-security-operations/verify-premerge-log-2026-03-05.md`, `04-security-operations/verify-release-log-2026-03-05.md` |
| WS5-06 | Data Room | 투자자 제출본 원본/요약본 제작 | denjoy | 맹준호 | 2026-03-20 | DONE | `06-investor-pack/`, `06-investor-pack/original/DenJOY-DataRoom-v1-2026-03-05.zip`, `06-investor-pack/original/DenJOY-DataRoom-v1-2026-03-05.zip.sha256`, `06-investor-pack/redacted/2026-03-05_investor-pack-redacted-summary_v1.md`, `06-investor-pack/redacted/2026-03-05_legal-finance-review-round_v1.md` |

## 오늘 기준 실행 순서 (2026-03-05 업데이트)

1. `WS3-03` 다음 주차 session_id 누락률 점검 실행 (Weekly)
2. `WS5-05` 다음 제출 주차 보안 운영 증빙 갱신
3. 실결제 전환 후 MRR raw 검증 항목 재개
