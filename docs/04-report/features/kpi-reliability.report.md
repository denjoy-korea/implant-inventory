...
| ID | 요구사항 | 결과 |
|----|----------|:----:|
| R-01 | 03-04, 03-05 스냅샷 재생성 (stepCvr ≤ 100%) | ✅ 03-04: 50% (기존 270%), 03-05: 58% (기존 320%) |
| R-02 | 2026-02-25 ~ 2026-03-05 9일치 스냅샷 존재 | ✅ CI 백필(02-25~03-03) + MCP SQL 재생성(03-04, 03-05) |
| R-03 | 서비스 운영일 커버리지 100% | ✅ 9/9일 = 100% (CI 동적 임계값: 9 ≥ 9) |
