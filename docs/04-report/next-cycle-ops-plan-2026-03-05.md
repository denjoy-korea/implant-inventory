...
| --- | --- | --- | --- |
| 1 | WS3-03 session_id 주간 점검 재실행 | 2026-03-12 | `node scripts/traffic-snapshot-coverage-auto.mjs 28 --launch-date=2026-02-25 --end-date=2026-03-12` + `docs/04-report/traffic-kpi-daily/session-quality-check-2026-03-12.md` 작성 |
