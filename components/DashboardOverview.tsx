...
const DashboardOverview: React.FC<DashboardOverviewProps> = ({
  ...
  return (
    ...
    <AuditSessionDetailModal
      selectedAuditSessionKey={selectedAuditSessionKey}
      auditHistory={auditHistory}
      recentAuditSessions={recentAuditSessions}
      auditDetailShowAll={auditDetailShowAll}
      setAuditDetailShowAll={setAuditDetailShowAll}
      onClose={() => setSelectedAuditSessionKey(null)}
    />
