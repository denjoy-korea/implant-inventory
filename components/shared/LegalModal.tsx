            ...
            <section key={section.title} className="mb-9">
              ...
              {section.paragraphs.length === 1 ? (
                (() => {
                  ...
                  return (
                    <div className="my-3 flex gap-3 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3">
                      ...
                      <p className="m-0 font-medium leading-relaxed text-amber-900">{e.text}</p>
                    </div>
                  );
                })()
              ) : (
                <ol className="list-decimal list-outside ml-5 space-y-2">
                  {section.paragraphs.map((entry, idx) => {
                    if (typeof entry === 'string') {
                      return <li key={idx} className="pl-1">{entry}</li>;
                    }
                    return (
