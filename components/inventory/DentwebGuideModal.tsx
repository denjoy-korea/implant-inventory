...
const DENTWEB_GUIDE_STEPS: DentwebGuideStep[] = [
  {
    ...
    imageSrcSm: '/guide-dentweb-step4-sm.png',
    imageSrcXs: '/guide-dentweb-step4-xs.png',
  ...
  },
  {
    ...
    imageSrcSm: '/guide-dentweb-step3-sm.png',
    imageSrcXs: '/guide-dentweb-step3-xs.png',
  ...
  },
  {
    ...
    imageSrcSm: '/guide-dentweb-step2-sm.png',
    imageSrcXs: '/guide-dentweb-step2-xs.png',
  ...
  },
  {
    ...
    imageSrcSm: '/guide-dentweb-step1-sm.png',
    imageSrcXs: '/guide-dentweb-step1-xs.png',
      ...
      <div className="bg-white w-full max-w-5xl rounded-2xl shadow-2xl overflow-hidden max-h-[88vh] flex flex-col">
        <div className="px-4 sm:px-6 py-4 sm:py-5 bg-slate-900 text-white flex items-start justify-between gap-4 shrink-0">
          ...
          <button
            onClick={onClose}
            aria-label="닫기"
            className="h-11 w-11 inline-flex items-center justify-center rounded-full hover:bg-white/10 transition-colors"
          >
        ...
        <div className="px-4 sm:px-6 py-3 border-b border-slate-100 bg-slate-50/80 flex items-center justify-between gap-3">
        ...
        <div className="px-4 sm:px-6 py-4 flex-1 overflow-hidden">
          <section className={`h-full rounded-xl border p-4 flex flex-col gap-3 ${
            ...
            <div className={`flex-1 min-h-0 rounded-xl overflow-hidden border ${
              ...
              <img
                src={currentStep.imageSrcSm}
                srcSet={`${currentStep.imageSrcXs} 640w, ${currentStep.imageSrcSm} 960w, ${currentStep.imageSrc} 1920w`}
        ...
        <div className="px-4 sm:px-6 py-4 border-t border-slate-100 bg-slate-50 flex items-center justify-between shrink-0">
          <button
            onClick={() => setStepIndex(prev => Math.max(0, prev - 1))}
            disabled={isFirst}
            className={`px-4 py-2 rounded-xl text-sm font-black min-h-11 transition-colors ${
              isFirst
          ...
          {!isLast ? (
            <button
              ...
              className="px-5 py-2 rounded-xl min-h-11 bg-indigo-600 text-white text-sm font-black hover:bg-indigo-700 transition-colors"
            >
              다음
            </button>
          ) : (
            <button
              onClick={onClose}
              className="px-5 py-2 rounded-xl min-h-11 bg-slate-900 text-white text-sm font-black hover:bg-slate-700 transition-colors"
            >
              확인
            </button>
          )}
