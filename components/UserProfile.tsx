                            ...
                            <div className="space-y-2.5">
                                ...
                                <div className="flex items-center justify-center">
                                    <div className="flex items-center bg-slate-100 rounded-xl p-1 gap-1">
                                        <button onClick={() => setPickerCycle('monthly')} className={`px-4 py-1 rounded-lg text-xs font-bold transition-all ${pickerCycle === 'monthly' ? 'bg-white text-slate-800 shadow-sm' : 'text-slate-500'}`}>월간</button>
                                        <button onClick={() => setPickerCycle('yearly')} className={`flex items-center gap-1.5 px-4 py-1 rounded-lg text-xs font-bold transition-all ${pickerCycle === 'yearly' ? 'bg-white text-slate-800 shadow-sm' : 'text-slate-500'}`}>
                                            연간
