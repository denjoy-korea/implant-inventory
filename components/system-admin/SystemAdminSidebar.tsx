        ...
        <nav className="flex-1 overflow-y-auto custom-sidebar-scrollbar px-6 pb-6 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <nav className="space-y-1">
              ...
              <button onClick={() => onTabChange('beta_invites')} className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl font-bold transition-all text-sm duration-200 group ${activeTab === 'beta_invites' ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-900/50' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-200'}`}>
                ...
                <span className="min-w-0 flex-1 truncate whitespace-nowrap text-left">코드 관리</span>
              </button>
          ...
          <div className="pt-6 border-t border-slate-800">
            ...
            <nav className="space-y-1">
              ...
              <button onClick={() => onTabChange('lectures')} className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl font-bold transition-all duration-200 text-sm ${activeTab === 'lectures' ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-900/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white'}`}>
                <svg className="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.069A1 1 0 0121 8.845v6.31a1 1 0 01-1.447.894L15 14M3 8a2 2 0 012-2h8a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V8z" /></svg>
                <span>강의 관리</span>
              </button>
              ...
              <button onClick={() => onTabChange('billing')} className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl font-bold transition-all duration-200 text-sm ${activeTab === 'billing' ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-900/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white'}`}>
