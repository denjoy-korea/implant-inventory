      ...
      <div className="space-y-6">
        ...
        {returnCandidates.total > 0 && (
          <div className="hidden md:block bg-white rounded-[32px] border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="px-5 sm:px-7 pb-5 sm:pb-6">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-stretch sm:divide-x sm:divide-slate-200">

                {/* ── 미사용 기반 그룹 ── */}
                <div className="flex-1 sm:pr-5">
                  <p className="text-[10px] font-bold text-amber-600/80 tracking-widest mb-2 ml-0.5">미사용 기반</p>
                ...
                {/* ── 과잉 재고 그룹 ── */}
                <div className="sm:w-44 sm:pl-5">
                  <p className="text-[10px] font-bold text-indigo-600/80 tracking-widest mb-2 ml-0.5">과잉 재고</p>
                  {/* 권장량 초과 */}
                  <button
                    onClick={() => setShowOptimizeModal(true)}
                    className={`w-full group relative rounded-2xl border-2 p-4 transition-all text-left hover:shadow-md cursor-pointer ${returnCandidates.overstock.length > 0
