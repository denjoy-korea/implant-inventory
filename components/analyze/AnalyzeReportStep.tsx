...
import { BarChart, DonutChart, ScoreGauge } from './AnalyzeCharts';
import {
  buildQuickInsights,
  getGrade,
  gradeColorMap,
...
const AnalyzeReportStep: React.FC<AnalyzeReportStepProps> = ({
  ...
  return (
    <div ref={reportRef} className="min-h-screen bg-slate-50">
      ...
      {sizeFormatDetailItems && (
        <div className="fixed inset-0 z-[140] bg-black/50 backdrop-blur-sm flex items-center justify-center p-4" onClick={() => setSizeFormatDetailItems(null)}>
