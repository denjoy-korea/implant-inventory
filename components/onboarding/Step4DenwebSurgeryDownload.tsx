    ...
    <div className="px-6 py-6 flex flex-col h-full">
      ...
      <div className="space-y-2 mb-4 flex-1">
        {STEPS.map(({ step, label }, i) => (
          <div key={step}>
            <div className="flex items-center gap-4 bg-slate-50 rounded-2xl px-5 py-3.5 group">
              <span className="text-xs font-black text-indigo-500 w-5 shrink-0 group-hover:animate-icon-bounce">{step}</span>
