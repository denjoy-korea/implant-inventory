...
const AppGlobalOverlays: React.FC<AppGlobalOverlaysProps> = ({
  ...
  return (
    <>
      {planLimitModal && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-in fade-in duration-200" onClick={onClosePlanLimitModal}>
