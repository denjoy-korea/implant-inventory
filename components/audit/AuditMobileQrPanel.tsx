...
const AuditMobileQrPanel: React.FC<Props> = ({ auditUrl }) => {
  ...
  return (
    <div className="bg-white border border-indigo-200 rounded-2xl p-5 shadow-sm flex flex-col gap-4">
      <div>
        <p className="text-sm font-black text-slate-900">현장 실사 시작</p>
        <p className="text-[11px] text-slate-500 mt-0.5">스마트폰으로 QR 코드를 스캔하면 모바일 실사 화면으로 바로 이동합니다.</p>
      </div>
...
export default AuditMobileQrPanel;
